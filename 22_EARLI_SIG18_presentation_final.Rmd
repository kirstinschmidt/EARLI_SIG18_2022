...
<img src="images/study1_exp.2_small.png"
     width="550px"
     style="vertical-align:middle">
Virtual experiment 2 - .phgreenlight[intervention group 1 with small sampling options]
...
<img src="images/study1_exp.2_small_to_large.png"
     width="550px"
     style="vertical-align:middle">
Exp. 2 - .phgreenlight[Group 2 with small to large sampling options]
...
.pull-left[
    <img src="images/study1_exp.1.png"
     width="550px"
     style="vertical-align:middle">]
.pull-right[Virtual experiment 1 - open text box]
...
.pull-left[
    <img src="images/study1_exp.2_small_to_large.png"
     ...
     style="vertical-align:middle">]
.pull-right[
    Virtual experiment 2 - .phgreenlight[Intervention group 2 with small to large sampling options]]
...
<img src="images/study1_exp.2_text.png"
     width="550px"
     style="vertical-align:middle">
Virtual experiment 2 - .phgreenlight[control group with open text boxes]
...
* e.g., teaching to the test (Garner et al., 2017)

<br>

Anchoring effects in interpreting .phgreen[scientific evidence (RIEP)]
...
* H2 in the first study not evident: could indicate more factors effecting the last sampling -> in further analyses we include additional factors, like ...
