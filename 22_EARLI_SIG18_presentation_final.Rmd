...
* Teachers are encouraged to consider a great variety of .phgreenlight[evidence] ranging from .phgreenlight[formal or informal generated raw data] to .phgreenlight[results of educational research] in their professional actions .em06[(European Commission of the European Communities, 2007; Schildkamp, 2019)].
<br>
<br>
<br>
* Both concepts, .phgreenlight[data-based decision-making] and .phgreenlight[research-informed educational practice], can be combined under the overarching approach of .phgreenlight[evidence-informed practice] .em06[(Brown et al., 2017; Brown et al., 2022)].
<br>
<br>
<br>
* Advantages of data-based decision-making .em06[(Mandinach & Schildkamp, 2021)]:
...
<br>
<br>
* Advantages of research informed educational practice .em06[(Bromme et al., 2014; Flood & Brown, 2020; Stark, 2017)]:
...
# Anchoring Effect  `r fontawesome::fa_i(name = "anchor")` 
...
<br>
<br>
* The effect occurs because of the .phgreenlight[scale distortion] caused by the anchor .em06[(Mochon & Frederick, 2013)]
<br>
<br>
* Some results of previous research:
  ...
  * Expertise doesn't prevent from Anchoring necessarily.em06[(Dünnebier et al., 2009)]
  * tbd
<br>
<br>
...
- and when we want teachers to engage with evidence, data as well as scientific evidence, we need them to make precise estimations
...
- with the sampling as dependent variables and the anchor options as independent variables
...
???
- Frage @Samuel: passt die Skalierung?
...
* DBDM and RIEP are supposed to be objective methods &rarr; important to know about still possible biases
...
* Effects in assessments of student performance .em06[(Dünnebier et al., 2009)]
