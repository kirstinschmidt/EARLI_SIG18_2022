...
H<sub>1</sub>: <br>
a) The student teachers rate the sample size 2 as more appropriate if first presented with a small sample size (N<sub>1</sub>=15; small anchor) and afterwards with a large sample size (N<sub>2</sub>=500) than vice versa. <br>
b) There is no difference in student teachers' appropriateness rating of sample size 2 between the control group 1 (N<sub>1</sub>=15, N<sub>2</sub>=15) and control group 2 (N<sub>1</sub>=500, N<sub>2</sub>=500)
