...
H<sub>1</sub>: When student teachers are first presented with a small anchor (N<sub>2</sub>=15), they rate the second large sample size (N<sub>2</sub>=500) as more appropriate.
