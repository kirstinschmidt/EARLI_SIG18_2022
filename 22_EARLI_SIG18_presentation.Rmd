...
H<sub>1</sub>: When student teachers are first presented with a small anchor (N<sub>2</sub>=15), they rate the second large sample size (N<sub>2</sub>=500) as more appropriate (than the first sample size).

H<sub>2</sub>: When student teachers are first presented with a large anchor (N<sub>2</sub>=500), they rate the second small sample size (N<sub>2</sub>=15) as less appropriate (than the first sample size).

H<sub>3</sub>: In the control group, there are no differences between the appropriateness ratings of the first and second sample size. 
