...
<br>
<br>
* Both concepts, .phgreenlight[data-based decision-making] and .phgreenlight[research-informed teaching practice], can be combined under the overarching approach of .phgreenlight[evidence-informed practice] (Brown et al., 2017).
<br>
<br>
...
Randomized Controlled Trial with two experimental groups: .phgreenlight[*small anchor and small to large anchor*]
...
H<sub>1</sub>: The given sampling options (small sample vs. small to large sample = .phgreen[small anchor vs. small to large anchor]) influences the .phgreen[size of the initial sampling in the third virtual study]. <br> 
<!-- Das ist übrigens die Kommentarfunktion :-) -->
<br>
<br>
H<sub>2</sub>: The given sampling options .phgreen[(small sample vs. small to large sample = small anchor vs. small to large anchor)] influences the .phgreen[maximum sample size in the third virtual study].
