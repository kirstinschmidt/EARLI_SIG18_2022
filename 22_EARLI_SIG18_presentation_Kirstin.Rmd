...
- To answer our research question, 233 student teachers from the KA University of Eduaction participated in our study
...
- We conducted again an experimental study. 
- And in this study, participants were in total presented with two different study reports and were afterwards asked to rate the appropriateness of these described scientific studies. 
...
???
- In general, the assumption was that the sample size in study 1 influences the appropriateness ratings of the sample size in study 2. 
...
???
- In both studies, we found evidence for anchoring effects on student teachers’ engagement with different types of evidence. While Study 1 shows some evidence for anchoring effects on teacher students’ engagement with raw data,  the second study presents clear evidence for anchoring effects on interpreting scientific evidence. 
