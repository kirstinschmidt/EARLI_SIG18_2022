...
- In both studies, we found evidence for anchoring effects in the context of EIEP. While Study 1 shows evidence for anchoring effects on teacher students’ engagement with raw data <!-- passt das noch so? -->, the second one presents evidence for anchoring effects on interpreting scientific evidence. 
